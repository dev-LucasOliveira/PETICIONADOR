...
button.addEventListener("click", (e) => {
  ...
  const text = `
    <div style="text-align: justify; font-family: Arial, Helvetica, sans-serif; font-size: 12; line-height: 1.5">
      ...
      <br><br>
      <p><b>OUTORGANTE: ${name.toUpperCase()}</b>, ${nacionality}, ${civilState}, ${occupation}, portador(a) da carteira de identidade nº ${id} expedida pelo(a) ${idIssuedBy}, portador(a) do CPF sob o nº ${cpf}, residente e domiciliado à ${adress}, ${district} - ${city}/${state}, CEP: ${cep}, nomeia e constitui a outorgada abaixo qualificada em sua bastante procuradora.</p>
      <br><br>
